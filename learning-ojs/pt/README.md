...
Open Journal Systems (OJS) é uma solução de código aberto para gerenciar e publicar revistas acadêmicas online. O OJS é um sistema de gerenciamento e publicação operado por editor altamente flexível, que pode ser baixado gratuitamente e instalado em um servidor web local.
